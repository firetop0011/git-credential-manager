...
namespace GitCredentialManager.Tests
{
    public class WslUtilsTests
    {
        ...
        public void WslUtils_CreateWslProcess()
        {
            ...
            Assert.Equal(expectedArgs, process.Process.StartInfo.Arguments);
            Assert.Equal(expectedFileName, process.Process.StartInfo.FileName);
            Assert.True(process.Process.StartInfo.RedirectStandardInput);
            Assert.True(process.Process.StartInfo.RedirectStandardOutput);
            Assert.True(process.Process.StartInfo.RedirectStandardError);
            Assert.False(process.Process.StartInfo.UseShellExecute);
        }
        ...
        public void WslUtils_CreateWslProcess_WorkingDirectory()
        {
            ...
            Assert.True(process.Process.StartInfo.RedirectStandardError);
            Assert.False(process.Process.StartInfo.UseShellExecute);
            Assert.Equal(expectedWorkingDirectory, process.Process.StartInfo.WorkingDirectory);
        }
    }
}
